...
List<String> barList =  new ArrayList<String>();  
        ...
        while(!proxyUseable && !ProxyList.isOutOfProxies() && proxyObj != null)
            {
                ...
                try // 1.
                {
                    //~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
                        ...
                        System.out.println(Thread.currentThread().getName() + " trying proxy...");
                        proxyUseable = tryProxy(proxyObj);
                        System.out.println(Thread.currentThread().getName() + " Tried the proxy: " + proxyObj.toString());
    ...
    public boolean tryProxy(Proxy proxyObj) throws IOException
	{
		...
		//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
                     ...
                     {
                         connected=false;                         
                         System.out.println(Thread.currentThread().getName()+" Proxy didn't connect");
                     }//end if
                     ...
                     {
                     System.out.println(Thread.currentThread().getName()+" Proxy Set! Took: "+conTime+" ms");
		     connected = true;                     
                     }//end if		     
